...
init(_Args) ->
    ...
    % dtls feature
    _DtlsArgs = [{local, cache_ssl_sup}, cache_ssl_sup, []],
    _DtlsStart = {supervisor, start_link, _DtlsArgs},
    _DtlsSpec = #{ id => cache_ssl_sup, start => _DtlsStart, type => supervisor },

    {ok, {SupervisorConf, [CacheSpec, UdpSpec, TcpSpec, TlsSpec]}}.
